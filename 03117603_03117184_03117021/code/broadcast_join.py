...
small_dataset = sc.textFile("hdfs://master:9000/files/small_movie_genres.csv")
...
large_dataset = sc.textFile("hdfs://master:9000/files/ratings.csv")
...
# for i in final.take(20):
#     print(i)

lines = final.map(toCSVLine)
lines.saveAsTextFile('hdfs://master:9000/outputs/ratings_genres_broadcast_join.csv')
