...
sqlString1 = \
    "select count(_c0) as Movies_Per_Category, _c1 as Genres "  + \
	"from movie_genres " + \
    "group by Genres "
...
sqlString4 = \
    ...
    "where avg_per_cat.Genre == movies_per_cat.Genres " 

res = spark.sql(sqlString1)
res.registerTempTable("movies_per_cat")
res.show()
res2 = spark.sql(sqlString2)
res2.registerTempTable("avg_per_movie")
res2.show()
